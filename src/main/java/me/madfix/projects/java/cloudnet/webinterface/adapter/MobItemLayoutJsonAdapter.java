...
public class MobItemLayoutJsonAdapter implements JsonSerializer<MobItemLayout>,
    JsonDeserializer<MobItemLayout> {

  @Override
  public MobItemLayout deserialize(JsonElement jsonElement, Type type,
  ...
  @Override
  public JsonElement serialize(MobItemLayout mobItemLayout, Type type,
