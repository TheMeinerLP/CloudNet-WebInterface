...
public final class SQLSelectConstants {
    ...
    public static final String SELECT_PERMISSION_FROM_USER =
            "SELECT permission from `user_permission` WHERE userId = ?";
    public static final String SELECT_PERMISSION_IN_GROUP =
            "SELECT permission from `group_permission` WHERE permission = ? AND gId = ?";
    public static final String SELECT_PERMISSION_IN_USER =
            "SELECT permission from `user_permission` WHERE permission = ? AND userId = ?";
