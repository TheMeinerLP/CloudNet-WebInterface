...
public class AdvanceServerConfigJsonAdapter implements JsonSerializer<AdvancedServerConfig>,
    ...
    public AdvancedServerConfig deserialize(JsonElement jsonElement, Type type,
        ...
        boolean notifyPlayerUpdatesFromNoCurrentPlayer = object
                .get("notifyPlayerUpdatesFromNoCurrentPlayer").getAsBoolean();
        boolean notifyProxyUpdates = object.get("notifyProxyUpdates").getAsBoolean();
        boolean notifyServerUpdates = object.get("notifyServerUpdates").getAsBoolean();
        boolean disableAutoSavingForWorlds = object.get("disableAutoSavingForWorlds")
                .getAsBoolean();
