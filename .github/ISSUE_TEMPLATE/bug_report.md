...
about: Create an issue which describes a bug in web interface
title: ''
labels: bug
assignees: ''
...
<!-- This template is based on https://github.com/CloudNetService/CloudNet/blob/master/.github/ISSUE_TEMPLATE/bug_report.md -->